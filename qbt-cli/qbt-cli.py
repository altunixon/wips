...
if __name__ == '__main__':
    ...
    #         data_urls.add(a_trnt)
        ...
        #             # data_post['torrents'].append((a_file, byte_data, "application/x-bittorrent"))
        #     else:
        #         pass
    ...
    data_post['torrents'] = (
        os.path.basename(console_args.list_trnt[0]), 
        open(console_args.list_trnt[0], 'rb'), 
    ...
    print ('[#{status}] Content:\n{response}'.format(
        ...
        response = json.dumps(data_response.header, indent=4, sort_keys=True, ensure_ascii=False)
        )
    )
else:
    pass
