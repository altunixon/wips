...
![SAML flow](/imgs/saml-concepts-okta-saml_guidance_saml_flow.png "SAML flow")
...
![Single IdP](/imgs/saml-concepts-okta-saml_guidance_one_idp.png "Single IdP")
...
![Many IdPs](/imgs/saml-concepts-okta-saml_guidance_many_idp.png "Many IdPs")
...
![SPs with Subdomains](/imgs/saml-concepts-okta-saml_guidance_many_idp_subdomain.png "SPs with Subdomains")
...
![SP-initiated flow with Deep Link](/imgs/saml-concepts-okta-saml_guidance_deeplink.png "SP-initiated Login with Deep Link")
